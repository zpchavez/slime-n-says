...
// let pack = function(c,arg){ return [new Uint8Array([arg, arg >> 8]), new Uint8Array([arg, arg >> 8, arg >> 16, arg >> 24])][c]; };
// let setPrivateVar = function(n,v,w,e){Object.defineProperty(this,n,{value:v,writable:!!w,enumerable:!!e});};
// let setPublicVar = function(n,v,w){setPrivateVar.call(this,n,v,w,true);};
...
//     let waveBind = {modulate: this._mod, vars: this._temp};
//     let val = 0;
//     let curVol = 0;
